...
const formSchema = z.object({
  ...
  subject: z.string().min(1, "Sujet obligatoire"),
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input id="firstName" placeholder="Votre prénom" {...register("firstName")} aria-invalid={!!errors.firstName} />
                        {errors.firstName && (
                      ...
                      <div>
                        ...
                        <Input id="lastName" placeholder="Votre nom" {...register("lastName")} aria-invalid={!!errors.lastName} />
                    ...
                    <div>
                      ...
                      <Input id="phone" type="tel" placeholder="Votre numéro de téléphone" {...register("phone")} />
                    </div>
                    ...
                    <div>
                      ...
                      <Input id="subject" placeholder="Objet de votre message" {...register("subject")} aria-invalid={!!errors.subject} />
                    ...
                    <Button type="submit" className="w-full bg-est-rouge hover:bg-est-rouge/90" disabled={isSubmitting}>
